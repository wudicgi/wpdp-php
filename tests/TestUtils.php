...
class WPDP_TestUtils {
    ...
    public static function setIncludePath() {
        $paths_to_add = array(
            '../../wpio/' . (self::_debug ? 'source' : 'build'),
            '../' . (self::_debug ? 'source' : 'builds/full')
        );
    ...
    public static function setAssertOptions() {
        ...
        assert_options(ASSERT_CALLBACK, array('WPDP_TestUtils', 'assertHandler'));
    }
    ...
    public static function randomBool($denominator) {
        return (mt_rand(1, $denominator) == 1);
    }

    public static function randomItem(&$items, $denominator) {
        return (self::randomBool($denominator) ? array_rand($items) : $items[0]);
    }

    public static function randomString($minlen, $maxlen) {
    ...
    public static function randomBinary($minlen, $maxlen) {
